...
public class Serebro {
    ...
    private void coinFrame() {
        if (texture == null) {
            texture = new Texture(Gdx.files.internal("objects/sprite/serebro.png"));
        }
        byte FRAME_COLS = 2;
        byte FRAME_ROWS = 2;
    ...
    public Serebro() {
        coinFrame();
        position = new Vector2(Gdx.graphics.getWidth() * 3f / 100f, (480f / 2f) - (480f * 16.1f / 100f));
    }
